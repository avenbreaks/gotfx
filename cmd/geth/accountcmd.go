...
var (
	walletCommand = &cli.Command{
		Name:      "wallet",
		Usage:     "Manage Gitshock presale wallets",
		ArgsUsage: "",
		Description: `
    gotfx wallet import /path/to/my/presale.wallet
		...
		Subcommands: []*cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Gitshock presale wallet",
				ArgsUsage: "<keyFile>",
				Action:    importWallet,
				Flags: []cli.Flag{
					utils.DataDirFlag,
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gotfx account update [options] <address>

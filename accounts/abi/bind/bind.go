...
//
// Detailed usage document and tutorial available on the gotfx Wiki page:
// https://github.com/gitshock-labs/gotfx/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind

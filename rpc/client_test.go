...
// This test reproduces https://github.com/gitshock-labs/gotfx/issues/17837 where the
...
// It is the reproducer for https://github.com/gitshock-labs/gotfx/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("gotfx-test-ipc-%d-%d", os.Getpid(), rand.Int63())

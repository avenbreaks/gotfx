...
import (
	...
	"github.com/gitshock-labs/gotfx/crypto/signify"
	"github.com/gitshock-labs/gotfx/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/gitshock-labs/gotfx/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/gitshock-labs/gotfx/internal/version.gitDate="+env.Date)
	}
	...
	*workdir = makeWorkdir(*workdir)
	...
	for _, pkg := range debPackages {
		for distro, goboot := range debDistroGoBoots {
			// Prepare the debian package with the gotfx sources.
...
type debMetadata struct {
	...
	// gotfx version being built. Note that this
